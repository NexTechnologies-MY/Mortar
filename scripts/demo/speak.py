"""Synthesize Mortar's demo narration with Kokoro or a cloned Chatterbox voice.
...
def _resolve_kokoro_home() -> Path:
    ...
    default_dir = Path.home() / '.local/share/mortar-demo'
...
CB_HOME = Path(os.environ.get('CHATTERBOX_HOME', Path.home() / '.local/share/mortar-demo/chatterbox'))
